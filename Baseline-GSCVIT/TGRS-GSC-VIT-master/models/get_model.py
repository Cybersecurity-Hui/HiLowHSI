...
from .gscvit_high_low import gscvit_HL
from .gscvit_high_low_int import gscvit_HL_INT
def get_model(model_name, dataset_name, patch_size):
    ...
    elif model_name == 'gscvit_HL':
        model = gscvit_HL(dataset_name)
    elif model_name == 'gscvit_HL_INT':
        model = gscvit_HL_INT(dataset_name)
